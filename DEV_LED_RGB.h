...
struct DEV_LED_RGB : Service::LightBulb {               // ON/OFF LED

  int ledPin;                                       // pin number defined for this LED
  SpanCharacteristic *power;                        // reference to the On Characteristic
  
  DEV_LED_RGB(int ledPin) : Service::LightBulb(){       // constructor() method
...
struct DEV_RGB : Service::LightBulb {       // RGB LED (Command Cathode)
  ...
  DEV_RGB(int red_pin, int green_pin, int blue_pin) : Service::LightBulb(){       // constructor() method
